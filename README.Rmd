...
[![CircleCI](https://circleci.com/gh/ecohealthalliance/citesdb/tree/master.svg?style=shield){data-external="1"}](https://circleci.com/gh/ecohealthalliance/citesdb)
...
If you don't need any of the bells and whistles of this package, you can download the raw data as a single compressed TSV file from the [releases page](https://github.com/ecohealthalliance/citesdb/releases), or as a `.zip` file of many CSV files from the original source at <https://trade.cites.org/>.
