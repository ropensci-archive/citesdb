...
**citesdb** stores data in an on-disk [MonetDB](https://www.monetdb.org/) SQL database. If you want to use SQL commands for complex queries or otherwise want to directly access the database connection, use the `citesdb()` command:
