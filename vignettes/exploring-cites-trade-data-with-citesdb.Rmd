...
readRDS(system.file("extdata", "rcites_1.rds", package = "citesdb"))
```
...
```{r, echo = FALSE, eval = TRUE}
readRDS(system.file("extdata", "rcites_2.rds", package = "citesdb"))
```
...
```{r, echo = FALSE, eval = TRUE}
readRDS(system.file("extdata", "rcites_3.rds", package = "citesdb"))
```
...
```{r, echo = FALSE, eval = TRUE}
readRDS(system.file("extdata", "rcites_4.rds", package = "citesdb"))
```
